...
@section('title','Detail Arsip SPD')
                    ...
                    <div class="card-body" style="min-height:90vh">
                        <div class="card-body" style="margin-top:-20px;">
                                ...
                                <div class="col-lg-12 mt-4" style="margin-left:-19px; margin-bottom:40px;">
                                    <h4 class="box-title text-uppercase">kirim dokumen operation SPD/Cetak List Arsip<h4>
                                </div>
                            ...
                            <div class="row" style="width:100%;">
                                       ...
                                       <thead>
                                        ...
                                        <tbody style="text-align: center;">
                                            ...
                                            <tr style="text-align:left;">
                                                ...
                                                <td id="order_number">{{$item->order_number}}</td>
                                ...
                                <div style="width:100%;">
                                    <div class="button-items mt-2 float-right">
                                       <!-- <a href="/sendToMsgSPD" type="button" class="btn btn-secondary waves-effect waves-light mr-4" style="width:150px;">BATAL</a> -->
                                       <a href="/sendToMsgSPD" class="btn btn-info" style="background: transparent;color: #0d66fa;border: 0px; margin-right: 16px;">BATAL</a>
                                    ...
                                    <div class="button-items mt-2 float-left">
                                        <button type="button" id="btn_back" class="btn btn-info waves-effect float-right mb-1"  style="margin-right: 23px;border-radius: 6px;">Kembalikan Document</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal-body" style="margin:unset; padding:unset; margin:15px;">
    <form action="{{route('sendToMsgSPD.print_arsip')}}" method="post" id="messenger_form" target="_blank">
    @csrf
    ...
    <div class="row mt-2" style="justify-content: center; ">
                <div class="card" style="width:230px; min-height:100px; border: 1px solid #6666;">
                    ...
                    <select [sort]="false" name="from[]" id="lstview" class="form-control mt-2" size="12" multiple="multiple" style="width: 222px;margin: auto;border:unset;border-top:1px solid #6666;border-radius:unset; font-size: small;">
...
<div class="row">
    <div class="col-lg-12">
        <a href="/sendToMsgSPD" type="button" class=" title btn btn-primary btn-block m-auto">Data kosong Kembali ke menu SPD</a>
...
//   return /^[a-z]*$/i.test(value); });
                ...
                table = $('#tblDetail').DataTable({
                   ...
                   columnDefs:[ 
                    //    {ordering: false, targets:[2,3,4,5,6]}
                   ]
...
function submitDocument()
    {
        (function($) {
            ...
            $.ajax({
                ...
                url: "{{route('sendToMsgSPD.print_arsip')}}",
