...
<html>
    ...
    <title>CETAK LIST ARSIP SPK</title>
...
/*                content: counter(page);*/
                content: "Halaman " counter(page) " dari " ; 
                }
    ...
    <div class="content mb-4 mt-3 ml-3 mr-3">
        ...
        <header >
            ...
            <span class="pagenum"></span><span><?= $total; ?></span>
            </p>
            {{-- @endif --}}
            
        <center style="margin: auto; width:50%">
            <h4 class="judul">SERAH TERIMA DOKUMEN SPK</h4>
        ...
        <table id="printDocArsip" class="table" style="width:100%; font-size:smaller; text-align:center; border-top: 2px solid #6666; border-bottom:2px solid #6666;color:#1d1e4b;">
          
            <thead style="border-bottom: solid 2px #6666; border-top: solid 2px #6666;">
                <tr>
                    <th class="<?=$font_sz;?>" style="width:auto">NO</th>
            ...
            <tbody  style="padding: 3px 3px !important;line-height:auto;">
                    ...
                    <center>
                            ...
                            <header > 
                                ...
                                <center style="margin-top:25px;">
                                    <h4 class="judul" style="margin:auto; width:50%">SERAH TERIMA DOKUMEN SPK</h4>
       ...
       $('#printDocArsip').DataTable( {
        ...
        columnDefs: [ 
            {className: 'dt-td-left',targets: [1,2]},
