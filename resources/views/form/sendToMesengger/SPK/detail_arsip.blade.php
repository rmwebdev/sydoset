                ...
                <div class="col-lg-12" style="margin-top:-20px;">
                    <div class="card-body" style="min-height:90vh">
                        <div class="card-body" style="margin-top:-20px;">
                                <div class="col-lg-12 mt-4" style="position:relative; float:left; margin-bottom:40px; margin-left:-18px;">
                                    <h4 class="box-title  text-uppercase">kirim dokumen operation/Cetak List Arsip<h4>
                                </div>
                            ...
                            <div class="row" style="width:100%;">
                                ...
                                <div style="width:100%;">
                                    <div class="button-items mt-2 float-right">
                                       <a href="/sendToMsgSPK" class="btn btn-info" style="background: transparent;color: #0d66fa;border: 0px; margin-right: 16px;">BATAL</a>
                                       <!-- <a href="/sendToMsgSPK" type="button" class="btn btn-secondary waves-effect waves-light mr-4" style="width:150px;">BATAL</a> -->
...
<div class="modal-body" style="margin:unset; padding:unset; margin:15px;">
    <form action="{{route('sendToMsgSPK.print_arsip')}}" method="post" id="messenger_form" target="_blank">
    ...
    <div class="row mt-2" style="justify-content: center; ">
                <div class="card" style="width:230px; min-height:100px; border: 1px solid #6666;">
                    ...
                    <select name="from[]" id="lstview" class="form-control mt-2" size="12" multiple="multiple" style="width: 222px;margin: auto;border:unset;border-top:1px solid #6666;border-radius:unset; font-size: small;">
                        ...
                        <option value="number" class="number">SPK</option>
                        ...
                        <option value="tgl_serah_terima">Tgl Terima Dari Driver</option>
...
<hr style="margin-top:-5px;">
     ...
     <div class="d-inline mx-auto mb-4 mt-3">
        <a type="button" data-dismiss="modal" onclick="closeMdl()" class="btn btn-secondary waves-effect waves-light  mr-4" style="width:150px;color: white;">BATAL</a>
...
<div class="row">
    <div class="col-lg-12">
        <a href="/sendToMsgSPK" type="button" class=" title btn btn-primary btn-block m-auto">Data kosong Kembali ke menu SPK</a>
...
function submitDocument()
    {
        (function($) {
            ...
            $.ajax({
                ...
                url: "{{route('sendToMsgSPK.print_arsip')}}",
