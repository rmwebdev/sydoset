...
@section('title','Send To Messenger - SPK')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-body" style="min-height:90vh">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="text-uppercase box-title">Kirim Dokumen Operation SPK</h4>
                            </div>
                        </div>
                        ...
                        <!-- <div class="row" style="margin-top:18px"> -->
                            <!-- <div class="col-lg-12"> -->
                                <table id="sendToMsgSPK" class="table responsive">
                                </table>
                            <!-- </div> -->
                        <!-- </div> -->
                    </div>
    ...
    <script type="text/javascript">
        ...
        (function($) {
            $(document).ready(function() {
                ...
                table = $('#sendToMsgSPK').DataTable({
                    ajax: {
                        url: '/sendToMsgSPK/loadDataMsgSPK',
                        type:"POST",
                        dataSrc:'',
                        data : {
                       type:1
                    ...
                    columns: [ 
                        ...
                        { data:'tgl_serah_terima', title:'TANGGAL SERAH TERIMA',className: 'dt-td-center',width:"300px"},
                        {
                            ...
                            {
                                return '<a href="/sendToMsgSPK/detailArsipSPK/'+full.kode_arsip+'" class="btn btn-info btn-sm btn_Msg">Detail</a>';
