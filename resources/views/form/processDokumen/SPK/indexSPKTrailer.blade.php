            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-body" style="min-height:90vh">
                        <div class="row">
                            <div class="col-lg-12 mr-sm-2" style="">
                                <h4 class="box-title">REGISTRASI NOMOR SPK TRAILER FINANCE</h4>
                            </div>
            ...
            table = $('#example').DataTable({
                    ...
                    "initComplete": function(settings, json) {
                        ...
                        {   
                                ...
                                render: function(data, type, full, meta)
                                {
                                    $encoded = btoa(JSON.stringify({number:full.number, type:"2"}));
                        ...
                        { data:'ccms_number', title:'CCMS NUMBER', className: 'dt-td-center'},
                    ...
                    table.on( 'draw', function () {
                        ...
                        var buttonOpenDoc = '<div class="clearfix" style="float:right"><button class="btn" style="display:none;background:transparent !important;color:#0d66fa;margin-right:8px" onClick="hideCheck()">BATAL</button><button class="btn btn-info" style="margin-right:8px" onClick="openModal(\'kembalikan\')">Kembalikan Dokumen</button><button class="btn btn-info" style="" data-toggle="modal" data-target="#modal_openDoc" onClick="clearData()">Open Document</button></div>';
