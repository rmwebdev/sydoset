...
@section('title','Process Document - SPD')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="font-weight:600;color:#1d1e4b;">DETAIL SPD FINANCE</h4>
                                            ...
                                            <div class="row">
                                                <!-- <div class="col-lg-12" style="padding-left:0px !important;"> -->
                                                    <div class="col col-lg-6 col-md-12 col-xs-12" style="padding-left: 0px !important;">
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;vertical-align: top;">Barcode</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_customer" name="lbl_customer">{{$data[0]->barcode_number}}</label>
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;vertical-align: top;">Customer</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_customer" name="lbl_customer">{{$data[0]->customer_name}}</label>
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;vertical-align: top;">Order Number</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_order_number" name="lbl_order_number"> 
                                                        ...
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;">Depo</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_route" name="lbl_route">{{$data[0]->depo_name}}</label>
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;">Status SPD</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_driver" name="lbl_driver">
                                                    ...
                                                    <div class="col col-lg-6 col-md-12 col-xs-12" style="padding-left: 0px !important;">
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;">Nama</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_driver_2" name="lbl_driver_2">
                                                        ...
                                                        <label class="col-lg-4 col-md-4 col-xs-4 shipmentLabel" style="font-weight: 700;">ERP Status</label>
                                                        <label class="col-lg-1 col-md-1 col-xs-1 shipmentLabel" style="vertical-align: top;">:</label>
                                                        <label class="col-lg-6 col-md-6 col-xs-6 shipmentLabel" id="lbl_otm_status" name="lbl_otm_status">{{$data[0]->status_erp}}</label>
                                                    </div>
                                                <!-- </div> -->
                                            </div>
                                            <!-- <div class="row"> -->
                                                        ...
                                                        <div class="col-6">
                                                            <div class="clearfix" style="margin-top:1em;padding-bottom:6em;vertical-align:middle">
                                                                <label class="containerCheck" style="width:18px !important;">
                                                                    @if($data[0]->is_bundle)
                                                                        <input type="checkbox" name="checkBundlKwit" id="checkBundlKwit" value="1" checked >
                                                                    @else
                                                                        <input type="checkbox" name="checkBundlKwit" id="checkBundlKwit" value="1">
                                                                    @endif
                                                                    <span class="checkmark"></span>
                                                                    <span style="vertical-align: middle;font-weight:700;font-style:italic;padding-left:8px">Dalam satu kwitansi</span>
                                                                </label>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="clearfix" style="margin-top:1em;padding-bottom:6em;vertical-align:middle;">
                                                                <div class="form-group form-inline">
                                                                    ...
                                                                    <input type="text" class="form-control col-7" name="total_kwitansi" id="total_kwitansi" readonly/>
                                                                </div>
                                                                <div class="form-group form-inline">
                                                                    <label class="col-form-label col-4" style="margin-right:12px;text-align:left;">Nilai SPD</label>
                                                                    <input type="text" class="form-control col-7" name="nilai_spd" id="nilai_spd" value="{{$data[0]->amount_no_comma}}" readonly/>
                                                                </div>
                                                                <div class="form-group form-inline">
                                                                    <label class="col-form-label col-4" style="margin-right:12px;text-align:left;">Selisih</label>
                                                                    <input type="text" class="form-control col-7" name="selisih" id="selisih" readonly/>
                                                                </div>
                                                                <div class="form-group form-inline">
                                                                    <label class="col-form-label col-4" style="margin-right:12px;text-align:left;"></label>
                                                                    <input type="text" class="form-control col-7" name="selisih_tipe" id="selisih_tipe" value="{{$data[0]->selisih_tipe}}" readonly/>
                                                                </div>
                                                                <!-- <button class="btn" style="font-size: 14px;float:left;background:transparent !important; color:#0d66fa;font-weight:700;text-decoration: underline;" type="button" id="btnAddRow" name="btnAddRow">+ADD</button> -->
                                                            </div>
                                                        </div>
...
@section('js')
                ...
                tableAttr = $('#tbl_attr').DataTable({
                    ...
                    "columns":[
                        ...
                        {   
                            ...
                            {
                                if (full.remark) {
                                    return '<input type="text" class="form-control remark_attr" style="box-sizing:border-box;" name="remark_attr_'+meta["row"]+'" value="'+full.remark+'" disabled/>';
                                }
                                return '<input type="text" class="form-control remark_attr" style="box-sizing:border-box;" name="remark_attr_'+meta["row"]+'" disabled/>';
                        ...
                        {   
                            ...
                            render: function(data, type, full, meta)
                            {
                                ...
                                if (full.is_available) {
                                    return '<label class="containerCheck" style="width:18px !important;"><input type="checkbox" name="ada_check_'+meta["row"]+'" value="1" disabled checked><span class="checkmark"></span></label>';    
                                }
                                return '<label class="containerCheck" style="width:18px !important;"><input type="checkbox" name="ada_check_'+meta["row"]+'" value="1" disabled><span class="checkmark"></span></label>';
                        ...
                        {   
                            ...
                            render: function(data, type, full, meta)
                            {
                                if (full.container_pengganti) {
                                    return '<input type="text" class="form-control remark-doc" style="box-sizing:border-box;" name="remarks_'+meta["row"]+'" value="'+full.container_pengganti+'" disabled/>';
                                }
                                return '<input type="text" class="form-control remark-doc" style="box-sizing:border-box;" name="remarks_'+meta["row"]+'" disabled/>';
                        ...
                        {   
                            ...
                            render: function(data, type, full, meta)
                            {
                                ...
                                if (full.nilai_kuitansi) {
                                    return '<input type="text" class="form-control jml-kwit" style="box-sizing:border-box;" name="jml_kwt_'+meta["row"]+'" onchange="calculate()" value="'+full.nilai_kuitansi+'" disabled/>';
                                }
                                return '<input type="text" class="form-control jml-kwit" style="box-sizing:border-box;" name="jml_kwt_'+meta["row"]+'" onchange="calculate()" disabled/>';
    ...
    function submitDoc() {
        ...
        (function($) {
            ...
            $('.modal-body').empty();
            html = 
            '<label class="control-label" style="color: #1d1e4b;margin-bottom:2em;">Anda akan melakukan Proses Settlement, pastikan data sudah lengkap!</label>'+
    ...
    function actionButton(params) {
        (function($) {
            ...
            $.ajax({
                ...
                success: function (data) { 
                    if(data.stat == 1){
                        window.location.replace("{{url('/procesDocSPD')}}");
                    } else {
    ...
    function calculate() {
        (function($) {    
            ...
            table.rows().every(function () {
                ...
                jumlah += parseInt(accounting.formatNumber(nilai));
            });
