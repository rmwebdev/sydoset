                    ...
                    <div class="card-body" style="min-height:90vh">
                        <div class="card-body" style="margin-top:-20px;">
                                ...
                                <div class="col-lg-12 mt-4" style="margin-left:-19px; margin-bottom:40px;">
                                    <h4 class="box-title text-uppercase">kirim dokumen finance SPK Trailer/Cetak List Arsip<h4>
                                </div>
                                ...
                                <!-- <div class="col-lg-12"> -->
                                    ...
                                    {{-- <div class="btn-group-mdl">
                                        <div class="button-items" style="display:inline-flex; float: right">
                                           <a href="/showSPD" type="button" class="btn btn-secondary waves-effect waves-light mr-4 btn_cancel">Cancel</a> 
...
<div class="modal-body" style="margin:unset; padding:unset; margin:15px;">
    <form action="/printSPKTrailer" method="post" id="messenger_form" target="_blank">
    @csrf
                ...
                <div class="card" style="width:230px; min-height:100px; border: 1px solid #6666;">
                    ...
                    <select name="from[]" id="lstview" class="form-control mt-2" size="12" multiple="multiple" style="width: 222px;margin: auto;border:unset;border-top:1px solid #6666;border-radius:unset; font-size: small;">
                        ...
                        <option value="driver_name">Driver Name</option>
                         <option value="secondary_driver">Driver Name 2</option>
...
<!--                    <button type="button" id="lstview_rightAll" class="btn btn-default btn-lg btn-block">>></button>-->
...
<!--                    <button type="button" id="lstview_leftAll" class="btn btn-default btn-lg btn-block"><<</button>-->
...
var table;
        (function($) {
            $(document).ready(function() {
                    ...
                    buttons: [
                        {
                            ...
                            window.location.href = "/showSPKTrailer";
                            }
                        }, 
                        {
                            text:'Cetak',
                ...
                '<input type="text" class="form-control" style="display: inline !important;width:200px !important;vertical-align:middle !important;height: 30px; " placeholder="Search" id="Pencarian"/>'+
