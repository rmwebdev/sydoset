                    ...
                    <div class="card-body" style="min-height:90vh">
                        <div class="row">
                            <div class="col-lg-12 mb-4">
                                <h4 class="box-title text-uppercase">kirim dokumen finance SPD</h4>
                            </div>
                        </div>
                        
                                <table id="SPD" class="table responsive"></table>
                    </div>
                </div>
            </div> <!-- /.row -->
        </div>
                ...
                table = $('#SPD').DataTable({
                    ...
                    columns: [ 
                        ...
                        { data:'tgl_serah_terima', title:'TANGGAL SERAH TERIMA',className: 'dt-td-center',width:"300px"},
                        {
                            ...
                            {
                                return '<a href="/detailSPD/'+full.kode_arsip+'" class="btn btn-info btn-sm btn_Msg">Detail</a>';
