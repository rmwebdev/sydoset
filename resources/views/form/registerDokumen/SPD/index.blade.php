...
@section('css')
    ...
    #openDocTbl_wrapper div.dataTables_wrapper div.dataTables_paginate ul.pagination {
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-body" style="min-height:90vh">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="box-title">REGISTRASI NOMOR SPD</h4>
                            </div>
                        </div>
                        ...
                        <form action="#" method="POST" id="formSearch">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <input type="text" class="form-control" name="type" id="type" style="display:none" value="2">
                                        <div class="col-lg-4">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <table id="openDocTbl" class="table nowrap" style="width:100%;min-height:40vh;overflow-x:auto;">
                </table>
          
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" style="background: transparent;border-color:transparent;color:#0d66fa" id="btnTidak" data-dismiss="modal">TIDAK</button>
                ...
                table = $('#example').DataTable({
                    ...
                    columns: [ 
                        ...
                        {   
                            ...
                            render: function(data, type, full, meta)
                            {
                                ...
                                return '<a href="insertDocSPD/'+$encoded+'" style="text-decoration: underline;">'+full.number+'</a>';
                                
                            }
                        },
                        { data:'approve_date_formated', title:'APPROVE DATE', orderable: false, className: 'dt-td-center'},
                        { data:'customer_name', title:'CUSTOMER', orderable: false, },
                        { data:'status_erp', title:'STATUS ERP', orderable: false, className: 'dt-td-center'},
                        { data:'last_status', title:'LAST STATUS', orderable: false, className: 'dt-td-center'},
                    ...
                    "drawCallback": function ( settings ) {
                        ...
                        api.column(8, {page:'all'} ).data().each( function ( group, i ) {
                            if ( last !== group ) {
                                $(rows).eq( i ).before(
                                    '<tr class="group"><td colspan="9" style="background-color:#fff5e4">'+moment(group).format('DD-MM-YYYY')+'</td></tr>'
                                );
                    ...
                    $.ajax({
                        ...
                        success: function (data) { 
                            if(data.stat == 1){
                                ...
                                // tableOpenDoc.row.add(dataParse).draw(true);
            ...
            $('#terimaDocModal').on('show.bs.modal', function() {
                ...
                terimaDok = $('#tableTerimaDok').DataTable({
                    ...
                    "columns":[
                        ...
                        {
                            data:"approve_spd_date",
                            name:"approve_spd_date"
                        },
                        {
                            data:"number",
                            name:"action", 
                            render: function(data, type, full, meta){
                                ...
                                return '<button type="button" class="btn btn-info" style="width:100%;" onClick="terimaDokumen(\''+data+'\')"><i class="fa fa-plus"></i> &nbsp; TAMBAHKAN</button>';
                            }
                        },
                    ],
                    "order": [[4,'desc']]
